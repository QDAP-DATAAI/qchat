...
export const ChatUI: FC<Prop> = () => {
  ...
  return (
    <div className="relative col-span-6 h-full flex-1 overflow-hidden bg-pattern-bg shadow-md sm:text-lg md:col-span-5 lg:col-span-4 lg:text-xl xl:col-span-5">
