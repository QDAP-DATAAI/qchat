...
export default function RootLayout({ children }: { children: React.ReactNode }): JSX.Element {
  ...
  return (
    <html lang="en-AU" suppressHydrationWarning className="size-full overflow-hidden text-base font-light">
      <head>
        ...
        <GlobalConfigProvider>
          <Providers>
            <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
              <Header />
              <NavBar />
              <main className="size-full overflow-auto bg-pattern-bg bg-repeat">{children}</main>
              <Footer />
              <Toaster />
            </ThemeProvider>
          </Providers>
